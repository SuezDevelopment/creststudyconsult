  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden flex flex-col items-center">
      ...
      <section
        ref={servicesRef}
        id="services"
        className="py-20 md:py-32 flex flex-col items-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-green-50 w-full"
      >
        ...
        >
          ...
          >
            <motion.div
              className="bg-[#62b514] text-white p-3 rounded-full shadow-xl cursor-pointer relative"
